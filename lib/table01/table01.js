/* table01.js. Copyright 2017 Tomasz Konopka. */
...
makealive.lib.table01 = function (obj, x) {
    ...
    /**
     * @param xdi - object (one row)
     * @param xcols - array with column names (must match keys in xdi)
     */
    ...
    /**
     * @param xd - array with objects (one object per table row)
     * @param xcols - array with column names (strings, must match keys in xd[i])
     */
    ...
    var sortbycol = function (event) {
        ...
        var sorttype = -1 * parseInt(esrc.getAttribute('val'));
        esrc.setAttribute('val', sorttype);

        // get sort column
        var sortcol = esrc.innerHTML;
